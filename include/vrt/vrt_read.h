 ...
 * \param validate  True if validation should be done. If this is false, only buffer size is validated.
 *
 ...
 */
int32_t vrt_read_fields(const vrt_header* header, const void* buf, uint32_t buf_words, vrt_fields* fields, bool validate);
